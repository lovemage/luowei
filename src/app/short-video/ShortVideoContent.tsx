...
const adFAQs = [
  ...
  {
    id: "ad-faq-2",
    question: "「保證流量」是什麼意思？如果沒達標呢？",
    answer: "我們的流量禮包方案是台灣唯一保證流量的服務。根據您選擇的方案，我們承諾年度觀看量達標（例如菁英版 600 萬次、霸主版 1,200 萬次）。若未達標，全額退費，風險完全由我們承擔。",
  },
  {
    id: "ad-faq-3",
    question: "可投放的數據類型有哪些？",
    answer: "我們可針對四大數據類型進行精準投放：點讚評論（累積社交證明）、覆蓋式廣告（大面積品牌曝光）、精準粉絲（鎖定目標受眾獲取高質量追蹤者）、播放量（保證影片觸及效果）。根據您的行銷目標，量身規劃最佳組合。",
  },
  {
    id: "ad-faq-4",
    question: "PTT 對賭企業方案是什麼？適合我嗎？",
    answer: "PTT 是「共擔合作模式」，總預算由羅威與企業各出 50%（羅威以技術折抵），雙方利益綁定。一年內共同打造 IP，依淨利 20-30% 分潤。適合有品牌有預算但缺流量、想要保底成果、尋求長期合作的企業主。點擊方案卡片的「了解詳情」可查看完整說明。",
  },
  {
    id: "ad-faq-5",
    question: "你們跟一般的廣告代操公司有什麼不同？",
    answer: "我們是正規經營的實體傳媒公司，不是個人工作室或素人接案。擁有 TikTok 官方認證、數百位成功案例可驗證，並且是台灣唯一提供保證流量方案的團隊。我們用自己的信譽承擔風險，因為我們對數據有絕對的信心。",
  },
  {
    id: "ad-faq-6",
    question: "六六大順體驗方案適合什麼樣的企業？",
    answer: "六六大順方案（6 支影片，每支 $12,000，總計 $72,000）適合想先試水溫的企業主。先透過 6 支影片體驗我們的製作品質與流量效果，滿意後再升級到年度保證流量方案，降低決策風險。",
  },
];
